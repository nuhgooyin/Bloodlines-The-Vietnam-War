...
NAI = {
	...
	MAX_VOLUNTEER_ARMY_FRACTION = 0.60,			-- Countries will not send more than their forces time this number to aid another country
	...
	SEND_VOLUNTEER_EVAL_MAJOER_POWER = 100.0, 	-- How willing major powers are to send volunteers.
